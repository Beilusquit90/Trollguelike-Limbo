...
void TileTextures::LoadTextures()
{
	...
	AUX_RGBImageRec *texture8 = auxDIBImageLoadA("8.bmp");
	...
	AUX_RGBImageRec *texture9 = auxDIBImageLoadA("9.bmp");
	AUX_RGBImageRec *texture10 = auxDIBImageLoadA("10.bmp");
	AUX_RGBImageRec *texture11 = auxDIBImageLoadA("heart.bmp");
	AUX_RGBImageRec *texture12 = auxDIBImageLoadA("sword.bmp");

	glGenTextures(15, &textures[0]);		// первый элемент, сколько загружаем текстур. второй ссылка, на первый элемент массива
